<template>
  <div id="app">
    ...
    <div v-if="!screen_phone" class="item">
      ...
      <div class="test">
        <mavon-editor ref=md :subfield="subfield" :toolbarsFlag="toolbarsFlag" :editable="editable" :language="d_language" @change="change" @save="saveone" :ishljs="true" class="item-editor" v-model="help1" :autofocus="autofocus" :external_link="external_link" @imgAdd="$imgAdd" @imgDel="$imgDel" @subfieldtoggle="$subfieldtoggle" @previewtoggle="$previewtoggle" :imageFilter="image_filter">
